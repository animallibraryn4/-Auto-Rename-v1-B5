...
async def convert_ass_subtitles(input_path, output_path):
    ...
    try:
        ...
        raise Exception(f"Subtitle conversion error: {str(e)}")
...
async def convert_to_mkv(input_path, output_path):
    ...
    try:
        ...
        raise Exception(f"MKV conversion error: {str(e)}")
        ...
        try:
            ...
            if is_mp4_with_ass:
                ...
                try:
                    ...
                    await download_msg.edit(f"**Subtitle Conversion Error:** {e}")
                    return
            ...
            if watermark_text and (media_type in ["video", "document"] and 
                ...
                try:
                    ...
                    os.remove(path)
                    os.rename(watermarked_path, path)
                except Exception as e:
